...
[![Reproducible Builds](https://img.shields.io/badge/Reproducible_Builds-ok-success?labelColor=1e5b96)](https://github.com/jvm-repo-rebuild/reproducible-central#org.apache.maven.plugins:maven-artifact-plugin)
[![Jenkins Status](https://img.shields.io/jenkins/s/https/ci-builds.apache.org/job/Maven/job/maven-box/job/maven-artifact-plugin/job/master.svg?)][build]
[![Jenkins tests](https://img.shields.io/jenkins/t/https/ci-builds.apache.org/job/Maven/job/maven-box/job/maven-artifact-plugin/job/master.svg?)][test-results]
...
[test-results]: https://ci-builds.apache.org/job/Maven/job/maven-box/job/maven-artifact-plugin/job/master/lastCompletedBuild/testReport/
[build]: https://ci-builds.apache.org/job/Maven/job/maven-box/job/maven-artifact-plugin/job/master/
