...
* Goals Overview
  ...
  * {{{./describe-build-output-mojo.html}artifact:describe-build-output}} (experimental) describes build structure and output,

  * {{{./reproducible-central-mojo.html}artifact:reproducible-central}} (experimental) report shows if dependencies are proven Reproducible Builds at Reproducible Central.

* Usage

  General instructions on how to use the Artifact Plugin can be found on the {{{./usage.html}usage page}}. Some more
